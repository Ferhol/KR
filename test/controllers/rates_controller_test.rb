...
class RatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post rates_url, params: { rate: { name_r: @rate.name_r, price: @rate.price, range: @rate.range, times_of_day: @rate.times_of_day } }
    end
  ...
  test "should update rate" do
    patch rate_url(@rate), params: { rate: { name_r: @rate.name_r, price: @rate.price, range: @rate.range, times_of_day: @rate.times_of_day } }
